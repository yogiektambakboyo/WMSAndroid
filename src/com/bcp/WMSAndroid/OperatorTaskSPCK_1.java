...
public class OperatorTaskSPCK_1 extends ListActivity {

    private final String TAG_OPERATOR = "OperatorCode";
    private String OperatorCode = "";

    // url to make request
    private String url = "http://192.168.31.10:9020/ws/operatortaskshippingpck1.php?operatorcode=1";

    // JSON Node names
    private final String TAG_OPERATORTASKPPCK1= "operatortaskpickingpck1";
    ...
    // Cabang JSONArray
    JSONArray operatortaskspck1 = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.operatortaskshipperpck1);

        Intent in = getIntent();
        OperatorCode = in.getStringExtra(TAG_OPERATOR);

        // Hashmap for ListView
        ArrayList<HashMap<String, String>> OperatorTaskSPCK = new ArrayList<HashMap<String, String>>();

        // Creating JSON Parser instance
        JSONParser jParser = new JSONParser();

        url = "http://192.168.31.10:9020/ws/operatortaskshippingpck1.php?operatorcode="+OperatorCode;
        ...
        try {
            ...
            operatortaskspck1 = json.getJSONArray(TAG_OPERATORTASKPPCK1);

            // looping through All Barang
            for(int i = 0; i < operatortaskspck1.length(); i++){
                JSONObject c = operatortaskspck1.getJSONObject(i);
         ...
         * */
        ListAdapter adapter = new SimpleAdapter(this, OperatorTaskSPCK,
                R.layout.listoperatortaskshippingpck1,
                new String[] { TAG_TRANSACTIONDATE, TAG_TRANSACTIONCODE, TAG_ERPCODE},
                new int[] { R.id.OPTSPCK1_tgl, R.id.OPTSPCK1_TransactionCode,R.id.OPTSPCK1_ERPCode});
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String kodenota = ((TextView) view.findViewById(R.id.OPTSPCK1_ERPCode)).getText().toString();
                String tgl = ((TextView) view.findViewById(R.id.OPTSPCK1_tgl)).getText().toString();
